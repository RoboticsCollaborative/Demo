...
//    actual_position_pub = nh_.advertise<std_msgs::Float64>("/rdd/actual_position", 1);
    rdda_joint_pub = nh_.advertise<rdda::JointStates>("/rdd/joint_stats", 1);
}
...
//    std_msgs::Float64 position_msg;
    rdda::JointStates JointStates_msg;
...
/* Subscriber callback */
void RDDNode::subJointCommands_callback(const rdda::JointCommands::ConstPtr& msg) {
